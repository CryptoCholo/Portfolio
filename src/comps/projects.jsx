export default function Projects() {
    return (
        <div className="flex flex-col gap-14 w-full  justify-center items-center bg-violet-100 py-10 px-16 h-min font-serif">
            ...
            <div className="flex flex-col gap-5 bg-violet-50 items-end w-full py-10 px-10 rounded-2xl" style={{boxShadow: "-8px -6px 15px 0 #fff, 6px 8px 15px 0 rgb(0 0 0 / 15%)"}}>
                <h2> A Blog</h2>
